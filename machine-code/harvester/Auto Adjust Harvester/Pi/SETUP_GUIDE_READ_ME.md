Autoadjust Harvester Poll + TCP Server Setup Guide (Ubuntu 24.04 LTS, Raspberry Pi 4)

Assumptions
- User: rooted
- Project dir: /home/rooted/te-cli
- Scripts: autoadjust_harvester_poll.py, autoadjust_harvester_tcp_server.py
...
1) Upload via FileZilla to /home/rooted/te-cli:
   - autoadjust_harvester_poll.py
   - autoadjust_harvester_tcp_server.py

2) Make them executable:
```bash
cd ~/te-cli
chmod +x autoadjust_harvester_poll.py autoadjust_harvester_tcp_server.py
```
...
```bash
ss -ltnp | grep 8888
nc 192.168.10.1 8888   # expect CSV: ready_to_run,active_variety,blade_speed,belt_speed,blade_height,airknife_mode
```
