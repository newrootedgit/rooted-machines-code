Harvester Poll + TCP Server Setup Guide (Ubuntu 24.04 LTS, Raspberry Pi 4)

Assumptions
- User: rooted
- Project dir: /home/rooted/te-cli
- Scripts: harvester_poll.py, harvester_tcp_server.py
...
1) Upload via FileZilla to /home/rooted/te-cli:
   - harvester_poll.py
   - harvester_tcp_server.py

2) Make them executable:
```bash
cd ~/te-cli
chmod +x harvester_poll.py harvester_tcp_server.py
```
...
ExecStart=/home/rooted/te-cli/venv/bin/python /home/rooted/te-cli/harvester_poll.py
Restart=always
RestartSec=2
...
User=rooted
WorkingDirectory=/home/rooted/te-cli
ExecStart=/home/rooted/te-cli/venv/bin/python /home/rooted/te-cli/harvester_tcp_server.py
Restart=always
RestartSec=2
NoNewPrivileges=true
[Install]
...
```bash
ss -ltnp | grep 8888
nc 192.168.10.1 8888   # expect CSV: belt_speed,mode
```
...
```bash
# Edit harvester_tcp_server.py and set HOST = "0.0.0.0"
